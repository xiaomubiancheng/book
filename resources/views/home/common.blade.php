...
<head>
    ...
    <link rel="stylesheet" href="{{asset('home')}}/css/weui.css" >
    <link rel="stylesheet" href="{{asset('home')}}/css/book.css" >
    <link rel="stylesheet" href="{{asset('home')}}/css/swipe.css" >
</head>
<body>
<div class="bk_title_bar">
    <img class="bk_back" src="{{url('home/images/back.png')}}" alt="" onclick="history.go(-1);">
    <p class="bk_title_content"></p>
    <img class="bk_menu" src="{{url('home/images/menu.png')}}" alt="" onclick="onMenuClick();">
</div>
<div class="page">
    @yield('content')
</div>
...
<script src="{{asset('home/js')}}/swipe.min.js"></script>
<script src="{{asset('home/js')}}/book.js"></script>
@yield('my-js')
</html>
